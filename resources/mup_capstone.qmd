...
In the case of plan making workshops, faculty typically do the work of setting up a particular relationship and deliverable with a community or client and then organize class engagement with that deliverable over the course of a semester. The output from the workshop will typically be a plan, report, or other professional document designed to be shared back with the client.

A Master's project can be initiated and completed as an individual or in groups of several students. A Master's project is written in plain and accessible language, typically contains highly polished visual elements, and oftentimes has a structure that follows that of a plan, policy report, or policy white paper.
...
I often have students ask me to help them determine which option might be most appropriate for them. It's complicated! The majority of MUP students (probably 90 percent) choose to complete the workshop option, leaving the other 10 percent to choose the project or thesis option. Why? In general, it's because the majority of MUP students' capstones track from professional work that they started through those workshops, as well as internships, class projects, other professional work.
