...
In this workshop, we’ll work with a local government client to describe threats to local housing stability and will develop appropriate strategies and recommendations responsive to local housing submarkets. Students can expect to engage directly with local government and community stakeholders, as well as other housing professionals. Outputs will include an analysis of local threats to housing stability, a review of best practices from other communities facing similar challenges, and recommendations for government and housing practitioners.
